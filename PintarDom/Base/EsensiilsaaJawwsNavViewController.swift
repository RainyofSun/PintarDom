...
class EsensiilsaaJawwsNavViewController: APPNavigationViewController {
    override func buildNavigation() {
        ...
        self.navigationAppearanceSetting(Style.opaque(backgroundColor: UIColor.clear, titleColor: UIColor.ppBlack33, font: UIFont.loadSpecialFont(size: 18, ftStyle: FontStyle.Inter_Bold), backImg: UIImage(named: "setting_back") ?? UIImage()))
    }
