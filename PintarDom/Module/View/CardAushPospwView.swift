...
class CardAushPospwView: EsensiwlwsBadisnPresentView {
    ...
    private lazy var leftBtn: UIButton = {
        ...
        view.setImage(UIImage(named: "auth_card_pop_left"), for: UIControl.State.normal)
    ...
    private lazy var midBtn: UIButton = {
        let view = UIButton(type: UIButton.ButtonType.custom)
        view.setImage(UIImage(named: "auth_card_pop_mid"), for: UIControl.State.normal)
    ...
    private lazy var rightBtn: UIButton = {
        let view = UIButton(type: UIButton.ButtonType.custom)
        view.setImage(UIImage(named: "auth_card_pop_right"), for: UIControl.State.normal)
